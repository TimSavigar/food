...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section - Dark cooking scene with hand pouring oil */}
      <section className="relative h-screen bg-cover bg-center bg-no-repeat" style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80')`
      }}>
        <div className="absolute inset-0 bg-black/40"></div>
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-white px-4">
          
          {/* Main Title */}
          <h1 className="text-6xl md:text-7xl font-bold text-center mb-4 tracking-wide">
            Recipe Ideas
          </h1>
          ...
          <form onSubmit={handleSearch} className="max-w-2xl mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full px-6 py-4 text-lg border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent shadow-lg"
              />
              <button
                type="submit"
            ...
            <div className="group cursor-pointer">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">Try our daily suggested dish</p>
                </div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">Healthy and delicious meatless options</p>
                </div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">Recipes inspired by the seasons</p>
                </div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">Recipes from around the globe</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Bottom Recipe Grid - Additional Featured Recipes */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
